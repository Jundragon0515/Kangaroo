		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="/"><img src="../resources/img/fav.png" alt="">  Kangaroo</a>
...
<!-- 							<li class="nav-item active"><a class="nav-link" href="/">Home</a></li> -->
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false">중고 거래</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="/">중고 직거래</a></li>
									<li class="nav-item"><a class="nav-link" href="/">중고 안전거래</a></li>
									<li class="nav-item"><a class="nav-link" href="/">중고 경매</a></li>
								</ul>
							</li>
							<li class="nav-item "><a class="nav-link" href="/">고객센터</a></li>
							<li class="nav-item "><a class="nav-link" href="/">공지사항</a></li>
							<li class="nav-item "><a class="nav-link" href="/">포인트충전</a></li>
							<c:choose>
								<c:when test="">
								...
								<li class="nav-item"><a href="#" class="cart"><span class="ti-bag"></span></a></li>//쪽지모양
	...
	<section class="banner-area">
		<div class="container">
			<div class="row fullscreen2 align-items-center justify-content-start" style="height:660px;">
				<div class="col-lg-12">
