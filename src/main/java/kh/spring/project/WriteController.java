...
public class WriteController {
	...
	public String goodsRegisterProc(MultipartHttpServletRequest mtfRequest,Used_transaction_boardDTO dto,Used_transaction_img_boardDTO udto) {
			try {
	...
	public String ActionWriteCompleteProc(MultipartHttpServletRequest mtfRequest,Auction_boardDTO adto,Auction_img_boardDTO idto) {
		...
		try {
			...
			sv.actionInsert(mtfRequest,adto, idto);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "home";
