...
public class Auction_boardDTO {
   ...
   private String trade_type;         // 거래 종류
...
public Auction_boardDTO(int no, String id, String title, String title_img, String phone, String contents, int viewCount,
		String start_date, int period, String end_date, int starting_price, int min_price, int present_price,
		String member_class, String account, int bid_count, String category, String trade_type, String delivery_type,
